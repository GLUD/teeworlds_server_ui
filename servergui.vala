...
void correr(){
    try{
        Process.spawn_command_line_async("killall -9 teeworlds_srv");
        Process.spawn_command_line_async("./teeworlds_srv -f serverconfig.cfg");
        Process.spawn_command_line_async("./teeworlds");
    }catch(Error e){}
}
...
main(string[] args){
    ...
    var button = new Button.with_label ("Guardar y correr");
